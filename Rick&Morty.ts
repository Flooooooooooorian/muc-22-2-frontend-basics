...
const getAliveHumans = (characters: Character[]) => {
    return characters.filter((character) => {
        return character.species === "Human" && character.status === "Alive"
    })
}


const aliveHumans = getAliveHumans(api.results)

console.log(aliveHumans)

//   Methoden Name (Parameter:Parameter-Typ,) : Rückgabe-Typ
const getNames = (characters: Character[]): String[] => {
...
console.log()
console.log(getNames(api.results))


const getNameAndOrigin = (characters: Character[]) => {
    return characters.map((character) => {
...
console.log()
console.log(getNameAndOrigin(api.results))
